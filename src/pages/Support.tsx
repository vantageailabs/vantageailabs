    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container px-4 py-12 md:py-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <Badge className="mb-4 bg-primary/10 text-primary border-0">Hosting & Support</Badge>
          <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">
            Keep Things <span className="text-gradient-accent">Running Smoothly</span>
          </h1>
          <p className="text-lg text-muted-foreground">
            Flexible hosting and support options to keep your digital presence maintained, secure, and always improving.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-center mb-8">
            Content <span className="text-gradient-accent">Management</span>
          </h2>
