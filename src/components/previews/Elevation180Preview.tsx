...
const Elevation180Preview = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-indigo-50/30 to-violet-50/20 text-slate-900 p-6 rounded-lg min-h-[500px] overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-500 text-xs">Executive Performance Platform</p>
          </div>
        </div>
        <div className="flex items-center gap-2 bg-slate-200 text-slate-600 text-xs px-3 py-1.5 rounded-full">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <Input 
                ...
                className="bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-400 pl-10 h-11 focus-visible:ring-violet-500/50"
              />
            </div>
            <div className="flex gap-2">
              <Button className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white border-0 h-11 px-5 font-medium shadow-md shadow-violet-500/20">
                TrueFit
              </Button>
              <Button variant="outline" className="bg-white border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900 h-11 px-5 font-medium">
                HeadHunter
              </Button>
              <Button variant="outline" className="bg-white border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900 h-11 px-5 font-medium">
                360
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-slate-900">Executive Team</h3>
          <span className="text-xs text-slate-500">6 members</span>
        </div>
        <div className="text-xs text-slate-600">
          Team Average: <span className="text-violet-600 font-semibold">B+ (87.2)</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        {teamMembers.map((member, i) => (
          <Card key={i} className="bg-white border-slate-200 shadow-sm hover:shadow-md hover:border-violet-200 transition-all cursor-pointer group">
            <CardContent className="p-4">
              <div className="flex items-start justify-between mb-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-violet-100 to-indigo-100 flex items-center justify-center text-sm font-semibold text-violet-700 border border-violet-200">
              ...
              <div className="mt-3 space-y-1.5">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-slate-900 font-medium">{member.energy}</span>
                </div>
